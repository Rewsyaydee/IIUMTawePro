...
If the Supabase dashboard shows `SUPABASE_PUBLISHABLE_KEY`, use it as `VITE_SUPABASE_ANON_KEY`.
If it shows `SUPABASE_SECRET_KEY`, keep it server-only and use it as `SUPABASE_SECRET_KEY`.
