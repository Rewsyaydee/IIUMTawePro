...
If no arguments are provided, run `'C:\Users\Rusyaidi\.cargo\bin\ctx.exe' --repo-root 'C:\Users\Rusyaidi\Documents\TawePro' memory bootstrap` so CTX scans common files such as:
- `AGENTS.md`
- `CLAUDE.md`
- `CODEX.md`
