...
Run the provided shell command in the current repository and pipe its combined output into `'C:\Users\Rusyaidi\.cargo\bin\ctx.exe' --repo-root 'C:\Users\Rusyaidi\Documents\TawePro' prune logs --max-lines 50`.
