...
!`'C:\Users\Rusyaidi\.cargo\bin\ctx.exe' --repo-root 'C:\Users\Rusyaidi\Documents\TawePro' memory import --from "$2" --scope "toolbook:$1" --source toolbook --prefix "toolbook.$1"`
